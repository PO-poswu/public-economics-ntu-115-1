...
brookfieldDiscussionWayTeaching2012-PREPARING FOR DISCUSSION (Page 44-45)

::: incremental
- Begin every lecture with one or more questions that you're trying to answer.
...
<!-- Dropped from the original demo: Executable Code, because it runs an R chunk that requires R and ggplot2. -->
...
<!-- Dropped from the original demo: Column Layout, because its example table is produced by an R/knitr chunk. -->
...
<!-- Dropped from the original demo: Tabsets, because both tabs execute R chunks. -->

<!-- Dropped from the original demo: Interactive Slides with leaflet/htmlwidgets, because it requires R and the leaflet package. -->

<!-- Dropped from the original demo: Interactive Slides with Observable/Shiny, because the demo data is created by R and the visualization imports JS modules from a CDN. -->
...
press {{< kbd s >}} (or use the tools in presentation menu ![](images/presentation-menu.png){style="padding-bottom: 1px; margin: 0" width="0.5em" height="0.5em"}) to open speaker view
...
Press {{< kbd r >}} (or use the tools in presentation menu ![](images/presentation-menu.png){style="padding-bottom: 1px; margin: 0" width="0.5em" height="0.5em"}) to open scroll view
...
<!-- Dropped from the original demo: Authoring Tools with Jupyter/VS Code, because it is a tooling showcase rather than a reusable slide feature. -->

<!-- Dropped from the original demo: Authoring Tools with RStudio, because it is a tooling showcase rather than a reusable slide feature. -->
